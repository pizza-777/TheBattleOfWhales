...
const rd1 = (await $`everdev c d RD.sol -d roundCode:${RoundContract.code},betCode:${BetContract.code},side:1 -s tradingBot -v 10000000000`).stdout
const rd1Addr = rd1.match(/(-1|0):[0-9a-f]{64}/)[0]
const rd2 = (await $`everdev c d RD.sol -d roundCode:${RoundContract.code},betCode:${BetContract.code},side:2 -s tradingBot -v 10000000000`).stdout
